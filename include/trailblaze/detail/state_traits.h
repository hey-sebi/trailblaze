...
struct has_xy<TState, std::void_t<decltype(std::declval<TState&>().x),
                                  decltype(std::declval<TState&>().y)>> : std::true_type
{
};
...
template <typename TState>
struct has_xyz<TState, std::void_t<decltype(std::declval<TState>().x),
...
struct has_quat<TState, std::void_t<decltype(std::declval<TState>().rotation.x),
                                    ...
                                    decltype(std::declval<TState>().rotation.w)>>
    : std::true_type
{
};
