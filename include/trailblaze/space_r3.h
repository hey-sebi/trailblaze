...
// -------------------- Accessors --------------------
namespace access {
inline double& x(R3& s) noexcept { return s.x; }
inline double& y(R3& s) noexcept { return s.y; }
inline double& z(R3& s) noexcept { return s.z; }
inline double x(const R3& s) noexcept { return s.x; }
inline double y(const R3& s) noexcept { return s.y; }
inline double z(const R3& s) noexcept { return s.z; }
}  // namespace access
...
struct StateSpace<R3> {
  ...
  using Interp = ComposeInterp<InterpR3>;
};
